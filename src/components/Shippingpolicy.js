...
const ShippingPolicy = () => {
  return (
    <div className="container box-return">
      ...
      <p>
        By using the Cultural Clothing Exchanges Portal and/or initiating a request for the purchase of products, you agree to the terms contained in this shipping policy without modification. If you do not agree to these terms, we advise you not to transact on culturalclothing.com.
      </p>
      <p>
